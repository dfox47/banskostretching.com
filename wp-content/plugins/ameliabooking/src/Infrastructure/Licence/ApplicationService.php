 ...
 */
class ApplicationService extends Lite\ApplicationService
{
    /**
    ...
    private static $licenseClassMap = [
        ...
        LicenceConstants::STARTER => 'AmeliaBooking\Infrastructure\Licence\Lite\ApplicationService',
        LicenceConstants::BASIC => 'AmeliaBooking\Infrastructure\Licence\Lite\ApplicationService',
        LicenceConstants::PRO => 'AmeliaBooking\Infrastructure\Licence\Lite\ApplicationService',
        LicenceConstants::DEVELOPER => 'AmeliaBooking\Infrastructure\Licence\Lite\ApplicationService',
    ];
    ...
    private static function getLicenseClass()
    {
        ...
        return self::$licenseClassMap[$currentLicense] ?? 'AmeliaBooking\Infrastructure\Licence\Lite\ApplicationService';
    }
