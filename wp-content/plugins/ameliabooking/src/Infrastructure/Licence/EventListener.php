...
class EventListener extends Lite\EventListener
{
    ...
    private static $licenseClassMap = [
        ...
        LicenceConstants::STARTER => 'AmeliaBooking\Infrastructure\Licence\Lite\EventListener',
        LicenceConstants::BASIC => 'AmeliaBooking\Infrastructure\Licence\Lite\EventListener',
        LicenceConstants::PRO => 'AmeliaBooking\Infrastructure\Licence\Lite\EventListener',
        LicenceConstants::DEVELOPER => 'AmeliaBooking\Infrastructure\Licence\Lite\EventListener',
    ];
    ...
    private static function getLicenseClass()
    {
        ...
        if (!AMELIA_DEV) {
            return 'AmeliaBooking\Infrastructure\Licence\Lite\EventListener';
        }
        ...
        return self::$licenseClassMap[$currentLicense] ?? 'AmeliaBooking\Infrastructure\Licence\Lite\EventListener';
    }
